        ...
        {syncResult && (
          <div
            style={{
              ...
              background: syncResult.failed.length > 0 ? 'var(--danger-bg)' : 'var(--status-passed-bg)',
              border: `1px solid ${syncResult.failed.length > 0 ? 'var(--danger-border)' : 'color-mix(in srgb, var(--status-passed) 25%, transparent)'}`,
            }}
          >
