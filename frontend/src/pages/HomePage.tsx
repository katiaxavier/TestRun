...
const COMPLETED_EXECUTIONS_LIMIT = 10; // janela usada por Taxa de Sucesso, gráfico de Qualidade e Atenção
...
function progressOf(execution: Execution) {
...
function executionTitle(execution: Execution) {
