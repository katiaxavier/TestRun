    ...
    >
      ...
      <div style={{ padding: '1rem' }}>
        ...
        <div style={{ marginBottom: '0.75rem' }}>
          ...
          <input autoFocus value={name} onChange={e => setName(e.target.value)} onKeyDown={e => e.key === 'Enter' && !loading && suites.length > 0 && handleSubmit()} placeholder="Ex: Regressão Sprint 25" />
        </div>
      </div>
    </Modal>
  );
